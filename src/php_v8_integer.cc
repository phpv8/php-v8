...
static PHP_METHOD(V8Integer, Value) {
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_v8_integer___construct, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 2)
                ZEND_ARG_OBJ_INFO(0, isolate, V8\\Isolate, 0)
                ZEND_ARG_TYPE_INFO(0, value, IS_LONG, 0)
ZEND_END_ARG_INFO()

PHP_V8_ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_v8_integer_Value, ZEND_RETURN_VALUE, 0, IS_LONG, 0)
ZEND_END_ARG_INFO()


static const zend_function_entry php_v8_integer_methods[] = {
        PHP_ME(V8Integer, __construct, arginfo_v8_integer___construct, ZEND_ACC_PUBLIC | ZEND_ACC_CTOR)
        PHP_ME(V8Integer, Value, arginfo_v8_integer_Value, ZEND_ACC_PUBLIC)
        PHP_FE_END
};
