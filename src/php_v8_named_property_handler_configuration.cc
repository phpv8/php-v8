...
#define this_ce php_v8_named_property_handler_configuration_class_entry
...
static void php_v8_named_property_handler_configuration_free(zend_object *object) {
...
static zend_object * php_v8_named_property_handler_configuration_ctor(zend_class_entry *ce) {

    php_v8_named_property_handler_configuration_t *php_v8_handler;

    php_v8_handler = (php_v8_named_property_handler_configuration_t *) ecalloc(1, sizeof(php_v8_named_property_handler_configuration_t) + zend_object_properties_size(ce));
...
static const zend_function_entry php_v8_named_property_handler_configuration_methods[] = {
        PHP_ME(NamedPropertyHandlerConfiguration, __construct, php_v8_named_property_handler_configuration___construct, ZEND_ACC_PUBLIC | ZEND_ACC_CTOR)
...
PHP_MINIT_FUNCTION(php_v8_named_property_handler_configuration) {
    zend_class_entry ce;
    INIT_NS_CLASS_ENTRY(ce, PHP_V8_NS, "NamedPropertyHandlerConfiguration", php_v8_named_property_handler_configuration_methods);
    this_ce = zend_register_internal_class(&ce);
    this_ce->create_object = php_v8_named_property_handler_configuration_ctor;
