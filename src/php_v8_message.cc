...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_v8_message_GetScriptOrigin, ZEND_RETURN_VALUE, 0, IS_OBJECT, "v8\\ScriptOrigin", 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_v8_message_GetScriptResourceName, ZEND_RETURN_VALUE, 0, IS_STRING, NULL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_v8_message_GetStackTrace, ZEND_RETURN_VALUE, 0, IS_OBJECT, "v8\\StackTrace", 1)
ZEND_END_ARG_INFO()
